    ...
    # Ajoutez ces gestionnaires pour la navigation entre les médias
            ...
            try:
                ...
                if direction == "next":
                    ...
                    if current_index >= total_media:  # Si on dépasse la fin
                        current_index = 0  # On revient au début
                else:  # prev
                    current_index = (current_index - 1)
                    if current_index < 0:  # Si on va en dessous de 0
                        current_index = total_media - 1  # On va à la dernière image
